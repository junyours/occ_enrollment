                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white/10 p-6 rounded-2xl backdrop-blur-lg border border-white/20 hover:bg-white/20 transition-all duration-300">
                                ...
                                <p className="text-gray-200 text-justify leading-relaxed">
                                    ...
                                    entrepreneurship. The college aspires to
                                    foster a community of learners equipped with
                                    21st-century skills, guided by integrity,
                                    and driven to create sustainable solutions
                            ...
                            <div className="bg-white/10 p-6 rounded-2xl backdrop-blur-lg border border-white/20 hover:bg-white/20 transition-all duration-300">
                                ...
                                <p className="text-gray-200 text-justify leading-relaxed">
                                    Opol Community College is committed to
                                    producing globally competitive graduates
                                    through advanced pedagogical practices,
                                    research-driven learning, and a culture of
                                    innovation. The college aims to nurture
                                    critical thinkers, ethical professionals,
                                    and socially responsible citizens who
                                    contribute meaningfully to the progress of
