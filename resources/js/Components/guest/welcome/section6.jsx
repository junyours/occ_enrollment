            ...
            <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                        We’d love to welcome you to Opol Community College! Our
                        campus is open for visits, inquiries, and community
                        engagement. Come and explore our vibrant learning
                        environment, meet our dedicated faculty, and discover
                        how OCC can help you achieve your goals.
                    </p>

                    <div className="space-y-2 text-gray-700 dark:text-gray-300">
                        <p>
                            <strong>📍 Address:</strong> Zone 1 Poblacion, Opol,
