...
export default function Scheduling({
    ...
    const startTimeChange = (value, type) => {
        ...
        if (type === 'meridiem') {
            ...
            // Update state
            setSelectedSubjectField('start_time', startTime);
            setSelectedSubjectField('end_time', endTime);
        }

        if (selectedSubject.day == 'TBA' || startTime == 'TBA') return;
    ...
    const meridiemChange = (value) => {
        ...
        const [, startMinStr] = selectedSubject.start_time.split(':');
        ...
        setSelectedSubjectField('start_time', start);
        setSelectedSubjectField('end_time', end);
        setMeridiem(value);
    ...
    const classHourChange = (value) => {
        ...
        const [startHour, startMin] = selectedSubject.start_time.split(':').map(Number);
