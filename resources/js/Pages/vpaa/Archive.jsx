...
export default function Archives({ auth, title }) {
  ...
  const archives = [
    { title: "Evaluation Result", type: "evaluation", href: "/vpaa/archives" },
    { title: "Student Evaluation List", type: "students", href: "/vpaa/studarchives" },
    // { title: "Reports", type: "report", href: "/reports" },
    { title: "Faculty Ranking", type: "ranking", href: "/vpaa/rankarchives" },
  ];
