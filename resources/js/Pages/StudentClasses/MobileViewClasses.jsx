                    ...
                    <Card className="mb-3">
                        <CardHeader className="pb-3">
                            <div className="flex items-center space-x-3">
                                <div className={`w-3 h-3 rounded-full bg-blue-500 ${classInfo.day === new Date().toLocaleString('en-US', { weekday: 'long' }) ? 'bg-green-500' : 'bg-blue-700'}`}></div>
                                <div>
                    ...
                    {/* Secondary Schedule */}
                    {
                        classInfo.secondary_schedule && (
                            <Card className="mb-3">
                                <CardHeader className="pb-3">
                                    <div className="flex items-center space-x-3">
                                        <div className={`w-3 h-3 rounded-full ${classInfo.secondary_schedule.day === new Date().toLocaleString('en-US', { weekday: 'long' }) ? 'bg-green-500' : 'bg-blue-500'}`}></div>
