...
class VPAAController extends Controller
{
    ...
    {
        return Inertia::render('vpaa/Archive/EvalResult', [
        ...
        public function evalfacultyList($schoolYearId, Request $request)
    {
        ...
        return Inertia::render('vpaa/Archive/FacultyList', [
            'faculty' => $faculty,
            'schoolYear' => $schoolYear,
            'semester' => $semester,
            'departments' => $departments,
    ...
    public function facultySubjects($facultyId, $schoolYearId, Request $request)
    {
        ...
        return Inertia::render('vpaa/Archive/FacultySubjects', [
            'faculty'       => $faculty,
            'schoolYear'    => $schoolYear,
    ...
    public function archiveEvaluationResult($facultyId, $studentSubjectId, $schoolYearId)
    {
        ...
        if (!$evaluation) {
            return Inertia::render('vpaa/Archive/EvaluationResult', [
                'faculty' => null,
                'subject' => null,
                'evaluation' => null,
                'criteria' => [],
    ...
    public function studEval()
    {
        ...
        return Inertia::render('vpaa/Archive/StudEval', [
            'title' => 'Archive',
    ...
    public function archivestudentList(Request $request, $schoolYearId = null)
    {
        ...
        return Inertia::render('vpaa/Archive/StudentsList', [
            'schoolYear' => $schoolYear,
    ...
    public function rankEval()
    {
        ...
        return Inertia::render('vpaa/Archive/RankEval', [
            'title' => 'Archive',
            'schoolYears' => $schoolYearsWithEval,
        ]);
    }
    ...
    {
        if (!$schoolYearId) {
            return Inertia::render('vpaa/Archive/RankingList', [
                'hasArchive' => false,
                'ranking' => [],
                'schoolYear' => null,
                'semester' => null,
