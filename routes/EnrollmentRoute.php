...
Route::middleware(['auth', 'maintenance', 'EnrollmentPermission'])->group(function () {
    ...
    Route::post('/enrollment/corinfo/mark-printed', [EnrollmentCourseSectionController::class, 'corMarkPrinted'])->name('enrollment.corinfo.mark-printed');
    Route::post('/enrollment/corinfo', [EnrollmentCourseSectionController::class, 'corInfo'])->name('enrollment.corinfo');
...
Route::middleware(['auth', 'maintenance', 'registrar'])->group(function () {
    Route::post('/schoolyear/view-subject-students/{schoolYearId}', [EnrollmentCourseSectionController::class, 'viewSubjectStudents'])->name('enrollment.schoolyear.view-subject-students');
...
Route::get('/enrollment-dashboard', [SchoolYearController::class, 'viewEnrollmentDashboard'])->name('guest.enrollment.dashboard');
Route::post('/guest/enrollment-data', [SchoolYearController::class, 'enrollmentData']);
