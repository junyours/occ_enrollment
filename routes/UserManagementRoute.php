...
Route::middleware(['auth', 'maintenance', 'role:registrar'])->group(function () {
    Route::get('/not-enrolled-list', [UserController::class, 'viewNotEnrolledList'])->name('not-enrolled-list');
    Route::post('/not-enrolled-list', [UserController::class, 'getNotEnrolledList'])->name('not-enrolled-list');
...
Route::middleware(['auth', 'maintenance', 'UserManagementPermission', 'program_head'])->group(function () {
