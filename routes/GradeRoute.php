...
Route::middleware(['auth', 'maintenance'])->group(function () {
    ...
    Route::middleware(['role:program_head,nstp_director'])->group(function () {
        Route::get('/submitted-grades', [GradeController::class, 'viewSubmittedGrades'])->name('submitted-grades');
        Route::post('/nstp/faculty-list/submitted-grades', [GradeController::class, 'getNstpFacultyListSubmittedGrades'])->name('nstp.faculty-list.submitted-grades');

        Route::get('/submitted-grades/{schoolYear}/{semester}/{facultyId}', [GradeController::class, 'viewFacultySubjects'])->name('grades.faculty.subjects');
        Route::get('/nstp/faculty-submitted-subjects/{schoolYearId}/{facultyId}', [GradeController::class, 'getNstpFacultySubmittedSubjects'])->name('nstp.faculty-submitted-subjects');

        Route::get('/submitted-grades/{schoolYear}/{semester}/{facultyId}/{sectionSubjectId}', [GradeController::class, 'viewSubjectStudents'])->name('faculty.subject.students');
    });

    Route::middleware(['role:nstp_director'])->group(function () {
        Route::post('/nstp/verify-grades/{period}/{sectionId}', [GradeController::class, 'nstpVerifyGrades'])->name('nstp.verify-grades');
        Route::post('/nstp/unverify-grades/{period}/{sectionId}', [GradeController::class, 'nstpUnverifyGrades'])->name('nstp.unverify-grades');

        Route::post('/nstp/reject-grades/{period}/{sectionId}', [GradeController::class, 'nstpRejectGrades'])->name('nstp.reject-grades');
        Route::post('/nstp/unreject-grades/{period}/{sectionId}', [GradeController::class, 'nstpUnrejectGrades'])->name('nstp.unreject-grades');
    });

    Route::middleware(['program_head'])->group(function () {
        ...
        Route::post('/submitted-grades/{schoolYear}/{semester}/{facultyId}', [GradeController::class, 'getFacultySubjects'])->name('grades.faculty.subjects');
    ...
    Route::middleware(['ClassesPermission'])->group(function () {
